...
<div id="settings-root" class="space-y-6">
        ...
        <div class="flex items-center gap-3">
            ...
            <div class="flex items-center gap-2">
                ...
                <button id="settings-theme-toggle" type="button"
                    class="relative inline-flex items-center h-7 w-14 rounded-full bg-stone-200 dark:bg-neutral-700 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                    aria-pressed="false">
            ...
            <a href="#"
                class="inline-flex items-center gap-2 px-3 py-2 rounded-md bg-stone-100 dark:bg-neutral-700 dark:text-neutral-100 text-sm hover:bg-stone-200 dark:hover:bg-neutral-600">View
                profile</a>
        </div>
    </header>
    ...
    <div class="lg:flex lg:items-start lg:gap-6">
        ...
        <nav id="settings-nav" aria-label="Settings sections"
            class="mb-4 lg:mb-0 lg:w-72 shrink-0 bg-white dark:bg-neutral-800 border border-stone-200 dark:border-neutral-700 rounded-xl p-4">
            <div class="flex items-center gap-3 mb-4">
                <img src="{{ $user->avatar_url ?? '/img/default-avatar.png' }}"
                    alt="{{ Auth::guard('freelancers')->user()->name ?? 'User' }}"
                    class="w-10 h-10 rounded-full object-cover border border-stone-200 dark:border-neutral-700 bg-stone-50 dark:bg-neutral-700" />
                <div>
            ...
            <div class="space-y-1">
                <button data-tab="profile"
                    class="w-full text-left px-3 py-2 rounded-md hover:bg-stone-100 dark:hover:bg-neutral-700 focus:outline-none"
        ...
        <section id="settings-panels" class="flex-1 space-y-6">
            ...
            <section id="panel-profile" role="tabpanel"
                class="tab-panel bg-white dark:bg-neutral-800 border border-stone-200 dark:border-neutral-700 rounded-xl p-6 shadow-sm">
                        ...
                        <div class="md:col-span-2 space-y-3">
                            ...
                            <label class="block">
                                ...
                                <textarea wire:model="bio" rows="3"
                                    class="mt-1 block w-full rounded-md border border-stone-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 py-2 px-3 text-gray-800 dark:text-neutral-100 focus:outline-none focus:ring-1 focus:ring-blue-500">{{ Auth::guard('freelancers')->user()->bio ?? '' }}</textarea>
                            </label>
                        </div>

                        <div class="flex flex-col items-center gap-3">
                            <div
                                class="w-28 h-28 rounded-full overflow-hidden border border-stone-200 dark:border-neutral-700 bg-stone-50 dark:bg-neutral-700">
            ...
            <section id="panel-security" role="tabpanel"
                ...
                <form action="#" method="POST" class="space-y-3 mb-6">
                    <label>
                        ...
                        <input name="current_password" type="password"
                            class="mt-1 block w-full rounded-md border border-stone-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 py-2 px-3 text-gray-800 dark:text-neutral-100 focus:outline-none focus:ring-2 focus:ring-indigo-500" />
                    </label>
                ...
                <div class="border-t border-stone-200 dark:border-neutral-700 pt-4">
                    <div class="flex items-center justify-between">
                        ...
                        <form action="#" method="POST">
                            <button type="submit"
                                class="px-3 py-2 rounded-md bg-stone-100 dark:bg-neutral-700 dark:text-neutral-100">Enable
                                / Disable</button>
                        </form>
                    </div>
                </div>
                ...
                <!-- Sessions -->
                <div class="border-t border-stone-200 dark:border-neutral-700 pt-4 mt-4">
                    ...
                    <ul class="space-y-2">
                        ...
                        <li
                            class="flex items-center justify-between p-2 rounded-md bg-stone-50 dark:bg-neutral-700 border border-stone-200 dark:border-neutral-700">
                            <div>
                    ...
                    <fieldset class="space-y-3">
                        ...
                        <label class="flex items-center gap-3">
                            <input id="notif-activity" name="notif_activity" type="checkbox"
                                class="h-4 w-4 rounded border-stone-300 dark:border-neutral-600 text-indigo-600" />
            ...
            <section id="panel-integrations" role="tabpanel"
                ...
                <div class="grid md:grid-cols-2 gap-4">
                    <div
                        class="p-4 rounded-md bg-stone-50 dark:bg-neutral-700 border border-stone-200 dark:border-neutral-700">
            ...
            <section id="panel-api" role="tabpanel"
                class="tab-panel hidden bg-white dark:bg-neutral-800 border border-stone-200 dark:border-neutral-700 rounded-xl p-6 shadow-sm">
                ...
                <form id="settings-create-key" action="#" method="POST" class="mb-4">
                    <label class="block">
                        ...
                        <input name="name"
                            class="mt-1 block w-full rounded-md border border-stone-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 py-2 px-3 text-gray-800 dark:text-neutral-100" />
                    </label>
                ...
                <div class="space-y-2">
                    <!-- Example key item -->
                    <div
                        class="flex items-center justify-between p-3 rounded-md bg-stone-50 dark:bg-neutral-700 border border-stone-200 dark:border-neutral-700">
                        <div>
                        ...
                        <div class="flex items-center gap-2">
                            <button data-copy="plain-api-key-string"
                                class="px-2 py-1 text-xs rounded-md bg-stone-100 dark:bg-neutral-600">Copy</button>
            ...
            <section id="panel-danger" role="tabpanel"
                ...
                <div class="space-y-4">
                    ...
                    <div
                        ...
                        <form action="#" method="POST">
                            <button class="mt-3 px-3 py-2 rounded-md bg-stone-100 dark:bg-neutral-600">Request
                                export</button>
                        </form>
                    </div>
                </div>
    ...
    <div id="modal-delete-account" class="fixed inset-0 hidden items-center justify-center z-50">
        ...
        <div class="relative max-w-lg w-full bg-white dark:bg-neutral-800 rounded-xl p-6 z-10">
            ...
            <p class="text-sm text-gray-500 dark:text-neutral-400 mb-4">Type <span
                    class="font-mono bg-stone-100 dark:bg-neutral-700 px-2 py-1 rounded">DELETE</span> to confirm.</p>
            <form id="modal-delete-account-form" action="#" method="POST">
                ...
                <div class="mt-4 flex gap-3">
                    <button type="button" data-modal-close="delete-account"
                        class="px-3 py-2 rounded-md bg-stone-100 dark:bg-neutral-700">Cancel</button>
