<div class="">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-5 gap-6 mb-10">
        ...
        <livewire:clients.client-stats-card heading="Total Clients" type="total" dataOverTime="Lifetime base"
            icon='
        ...
        <livewire:clients.client-stats-card heading="Active Retainers" type="active" dataOverTime="Ongoing"
        ...
        <livewire:clients.client-stats-card heading="Acquisition" type="acquisition" dataOverTime="Joined this month"
    ...
    {{-- View Client Modal --}}
    <flux:modal name="view-client-modal" class="w-full max-w-xl !p-0 shadow-2xl rounded-2xl" lazy>
    ...
    {{-- Edit Client Modal --}}
    <flux:modal name="edit-client-modal" class="w-full max-w-2xl !p-0 shadow-2xl rounded-2xl" lazy>
