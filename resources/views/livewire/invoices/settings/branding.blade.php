        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-y-6 gap-x-12">
            ...
            <div class="md:col-span-2">
                <div class="max-w-2xl space-y-6">
                    ...
                    <div
                        class="rounded-xl border border-dashed border-zinc-200 dark:border-zinc-800 p-4 text-xs text-zinc-500">
                            ...
                            @if ($settings->logo_path)
                                ...
                                <div class="mt-4 flex items-center justify-between">
                                    <a href="{{ asset('uploads/' . $settings->logo_path) }}" download
                                        class="group inline-flex items-center gap-2 rounded-lg px-3 py-2 text-xs font-semibold text-slate-700 dark:text-slate-200 bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700 hover:bg-blue-50 hover:text-blue-700 dark:hover:bg-blue-500/10 dark:hover:text-blue-400 transition-all duration-200">

                                        <span
                                            class="flex items-center justify-center w-6 h-6 rounded-md bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 group-hover:border-blue-300 dark:group-hover:border-blue-500 transition">
                                        ...
                                        <span class="tracking-tight">Download Original</span>
                                    </a>
                                </div>
                            @else
