...
<flux:modal name="add-project-modal" class="w-full max-w-2xl">
                ...
                <div class="space-y-6 mt-3">
                    ...
                    <div
                        ...
                        <flux:checkbox wire:model="notify_client"
                            label="Send project created notification to client via WhatsApp"
                            description="If unchecked, the project will be created silently." class="cursor-pointer"/>
                    </div>
                </div>
        ...
        @else
            <div class="flex flex-col items-center justify-center px-6 py-20 text-center">
                <div
                    ...
                    <svg class="w-7 h-7 text-neutral-400 dark:text-neutral-400" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                            d="M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m16 0h-2.586a1 1 0 00-.707.293l-2.414 2.414a1 1 0 01-.707.293h-3.172a1 1 0 01-.707-.293l-2.414-2.414A1 1 0 006.586 13H4" />
                    </svg>
                </div>
                <h3 class="text-base font-semibold text-neutral-900 dark:text-white">No project configuration available
                </h3>
            </div>
        @endif
    </div>
