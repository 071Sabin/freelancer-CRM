<div class="flex items-center gap-1">
    ...
    <flux:tooltip content="Download PDF" position="top">
        <button wire:click="$dispatchTo('invoices.invoice-form-modal', 'download-invoice', { id: {{ $row->id }} })" wire:loading.attr="disabled"
            ...
            {{-- Loading Spinner --}}
            <svg wire:loading wire:target="$dispatchTo('invoices.invoice-form-modal', 'download-invoice', { id: {{ $row->id }} })" class="animate-spin size-4"
            ...
            {{-- Download Icon --}}
            <flux:icon.arrow-down-tray wire:loading.remove wire:target="$dispatchTo('invoices.invoice-form-modal', 'download-invoice', { id: {{ $row->id }} })"
                class="size-4" />
