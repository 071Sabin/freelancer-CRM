...
<div>
    ...
    {{-- Layout --}}
    <div class="flex flex-col lg:flex-row lg:items-start gap-y-6 lg:gap-x-12">
        ...
        {{-- Separators: Fixed Mobile Visibility --}}
        <flux:separator vertical class="hidden lg:block" />
        <flux:separator class="block lg:hidden my-2" />
        
        {{-- Main Content: Swapped flux:main for a div to remove global padding --}}
